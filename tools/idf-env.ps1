...
$idf   = if ($env:TANMATSU_IDF_PATH)       { $env:TANMATSU_IDF_PATH }       else { "C:\Users\JorKsX\esp\esp-idf" }
$tools = if ($env:TANMATSU_IDF_TOOLS_PATH) { $env:TANMATSU_IDF_TOOLS_PATH } else { "C:\Users\JorKsX\.espressif" }
